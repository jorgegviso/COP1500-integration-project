## "Health Auditor" written by Jorge G. Viso
...
lowcarbs = "Your carbohydrate intake is low, consider snack options like bananas, apples, and raisins to supplement " \
           "more glucose! "
lowprotein = "Your protein intake is low, consider a quality whey or vegetarian based protein supplement in-between " \
             "meals! "
...
def weightprogram():
    print("Now that we've covered diet, let me recommend an exercise program.")
    ...
    print("Hee is my squat recommendation.")
    ...
    print("Hee is my deadlift recommendation.")
